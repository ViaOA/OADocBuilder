...
@XmlRootElement(name = "appUserErrorSearch")
...
public class AppUserErrorSearch extends OAObject {
    ...
    public static AppUserErrorSearch jaxbCreate() {
        AppUserErrorSearch appUserErrorSearch = (AppUserErrorSearch) OAObject.jaxbCreateInstance(AppUserErrorSearch.class);
        if (appUserErrorSearch == null) appUserErrorSearch = new AppUserErrorSearch();
