...
public class AppUserLoginLastDayFilter extends OAObject implements CustomHubFilter<AppUserLogin> {
    ...
    public static AppUserLoginLastDayFilter jaxbCreate() {
        AppUserLoginLastDayFilter appUserLoginLastDayFilter = (AppUserLoginLastDayFilter) OAObject.jaxbCreateInstance(AppUserLoginLastDayFilter.class);
        if (appUserLoginLastDayFilter == null) appUserLoginLastDayFilter = new AppUserLoginLastDayFilter();
