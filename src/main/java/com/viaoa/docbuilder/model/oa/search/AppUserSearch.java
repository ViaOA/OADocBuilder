...
@XmlRootElement(name = "appUserSearch")
...
public class AppUserSearch extends OAObject {
    ...
    public static AppUserSearch jaxbCreate() {
        AppUserSearch appUserSearch = (AppUserSearch) OAObject.jaxbCreateInstance(AppUserSearch.class);
        if (appUserSearch == null) appUserSearch = new AppUserSearch();
