...
@XmlRootElement(name = "appUserLoginConnectedFilter")
...
public class AppUserLoginConnectedFilter extends OAObject implements CustomHubFilter<AppUserLogin> {
    ...
    public static AppUserLoginConnectedFilter jaxbCreate() {
        AppUserLoginConnectedFilter appUserLoginConnectedFilter = (AppUserLoginConnectedFilter) OAObject.jaxbCreateInstance(AppUserLoginConnectedFilter.class);
        if (appUserLoginConnectedFilter == null) appUserLoginConnectedFilter = new AppUserLoginConnectedFilter();
        return appUserLoginConnectedFilter;
    }
