...
@XmlRootElement(name = "imageStoreSearch")
...
public class ImageStoreSearch extends OAObject {
    ...
    public static ImageStoreSearch jaxbCreate() {
        ImageStoreSearch imageStoreSearch = (ImageStoreSearch) OAObject.jaxbCreateInstance(ImageStoreSearch.class);
        if (imageStoreSearch == null) imageStoreSearch = new ImageStoreSearch();
