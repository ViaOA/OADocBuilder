...
package com.viaoa.docbuilder.resource;
...
public class Resource {
	...
	public static OAProperties getBundleProperties() {
		...
		try {
			InputStream resourceAsStream = OAObject.class.getResourceAsStream("/META-INF/maven/com.viaoa.docbuilder/docBuilder/pom.properties");
