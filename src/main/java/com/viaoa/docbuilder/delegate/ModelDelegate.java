...
import com.viaoa.docbuilder.control.single.SingleController;
...
public class ModelDelegate {
    ...
    private static final Hub<ProjectInfo> hubProjectInfos = new Hub<ProjectInfo>(ProjectInfo.class);
    private static final Hub<Tutorial> hubTutorials = new Hub<Tutorial>(Tutorial.class);
    // autoCreateOne
...
/*$$End: ModelDelegate1 $$*/
	...
	public static void initialize(ServerRoot rootServer, ClientRoot rootClient) {
        ...
        setSharedHub(getProjectInfos(), rootServer.getProjectInfos());
        setSharedHub(getTutorials(), rootServer.getTutorials());
        // autoCreateOne
...
/*$$End: ModelDelegate2 $$*/
    ...
    public static Hub<ProjectInfo> getProjectInfos() {
        return hubProjectInfos;
    }
    public static Hub<Tutorial> getTutorials() {
        return hubTutorials;
    }
    // autoCreateOne
