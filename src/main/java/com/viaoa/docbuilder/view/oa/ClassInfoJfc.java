...
public class ClassInfoJfc extends ClassInfoJfcBase {
    
    public ClassInfoJfc() {
    }
    
    public ClassInfoJfc(Hub<ClassInfo> hubClassInfo) {
        super(hubClassInfo);
    }
    
    public ClassInfoJfc(ClassInfoModel modelClassInfo) {
        super(modelClassInfo);
    }
