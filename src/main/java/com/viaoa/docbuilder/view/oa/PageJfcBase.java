...
import com.viaoa.docbuilder.model.oa.Page;
...
public class PageJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(PageJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(Page.P_Id);
    ...
    protected static final String CARD_Codes = "Codes";
    protected static final String CARD_ImageStores = "ImageStores";
    protected static final String CARD_ReferenceClassInfos = "ReferenceClassInfos";
    protected int TAB_ImageStores = -1;
    protected int TAB_Codes = -1;
    protected int TAB_ReferenceClassInfos = -1;
    protected JPanel cardPanel;
    protected CardLayout cardLayout;
    protected JTabbedPane tabbedPane;
    
    // Search
    protected PageSearchJfc jfcSearch;
    // hub Search
    protected PageSearchJfc jfcSearchHub;
    // Add
    protected PageSearchJfc jfcAdd;
    ...
    protected SectionJfc jfcSection;
    protected CodeJfc jfcCodes;
    protected ImageStoreJfc jfcImageStores;
    protected ClassInfoJfc jfcReferenceClassInfos;
    ...
    public PageJfcBase(Hub<Page> hubPage) {
        this.model = new PageModel(hubPage);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public PageJfcBase(PageModel modelPage) {
        if (modelPage == null) this.model = new PageModel();
        else this.model = modelPage;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("page.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("pages.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<Page> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // PageJfcBase.this.getEditDialog(this).setVisible(true);
                PageJfcBase.this.onNewPageCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<Page> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<Page> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, Page.P_Id), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                PageJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                PageJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public JPopupMenu createTreeNodePopupMenu(OATreeNode tn) {
        ...
        OAMenuItem mi;
        mi = getImageStoresJfc().createNewMenuItem();
        if (mi != null) menu.add(mi);
        mi = getImageStoresJfc().createAddMenuItem();
        if (mi != null) menu.add(mi);
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                Page page = PageJfcBase.this.onSearch();
                return page;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(Page.P_Id), 6) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                PageJfcBase.this.customizeRenderer(lbl, PageJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return PageJfcBase.this.getToolTipText(PageJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, Page page, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(Page page, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(Page.P_Id), 6) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                PageJfcBase.this.customizeRenderer(lbl, PageJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(Page.P_Id), 12, 6) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                PageJfcBase.this.customizeRenderer(label, PageJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(PageJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(PageJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                PageJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(PageJfc.getIcon());
        node.setForegroundColorProperty(PageJfc.PP_ForeColor);
        node.setBackgroundColorProperty(PageJfc.PP_BackColor);
        node.setIconColorProperty(PageJfc.PP_IconColor);
        node.setImageProperty(PageJfc.PP_Icon);
        node.setFontProperty(PageJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // Page client = (Page) table.getHub().getAt(row);
        // defaultValue = PageDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<Page> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<Page>(Page.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (PageJfcBase.this.getModel().getAllowGotoEdit()) {
                    PageJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "Page");
    ...
    public void createTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        tc = table.addColumn("Id", 6, new OALabel(getHub(), OAString.cpp(Page.P_Id)));
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Page.P_Id));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), Page.P_Id, 6);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(Page.P_Id));
            lbl.setToolTipTextPropertyPath(OAString.cpp(Page.P_Id));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                PageJfcBase.this.showCardPanel(PageJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JPanel createEditCardPanel(JTabbedPane tp) {
        ...
        // cardPanel.add(getCodesJfc().getCardPanel(), CARD_Codes); // this will be created when needed by showCardPanel(..)
        // cardPanel.add(getImageStoresJfc().getCardPanel(), CARD_ImageStores); // this will be created when needed by showCardPanel(..)
        // cardPanel.add(getReferenceClassInfosJfc().getCardPanel(), CARD_ReferenceClassInfos); // this will be created when needed by showCardPanel(..)
        return pan;
    }
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
        if (getModel().getClassInfoModel().getCreateUI()) {
            lbl = new JLabel("Class Info:");
            gc.anchor = gc.WEST;
            panel.add(lbl, gc);
            gc.anchor = gc.NORTHWEST;
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createClassInfoLabel();
            if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
            OAJfcControllerFactory.createOnlyAoNotNull(getHub(), lbl);
            cmd = createClassInfoCommand();
            comp = olbl;
        ...
        if (getModel().getSectionModel().getCreateUI()) {
        ...
        tabbedPane.addTab("Doc", icon, createDocHTMLTextPanel(), null);
        icon = Resource.getJarIcon("imageStore.gif");
        icon = new ScaledImageIcon(icon, 32, 20);
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (PageJfcBase.this.TAB_ImageStores == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != PageJfcBase.this.TAB_ImageStores) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                            if (bUseCombinedDetail) panThis = getImageStoresJfc().createCombinedPanel();
                            else panThis = getImageStoresJfc().createTablePanel();
                        }
                        catch (Exception e) {
                            ex = e;
                        }
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for Page", ex);
                        ...
                        tp.setComponentAt(PageJfcBase.this.TAB_ImageStores, panThis);
                    }
                };
                sw.execute();
            }
        });
        if (getModel().getImageStoresModel().getCreateUI()) {
            if ((this.TAB_ImageStores = tabbedPane.getTabCount()) == 0) {;
                JPanel panThis;
                if (bUseCombinedDetail) panThis = getImageStoresJfc().createCombinedPanel();
                else panThis = getImageStoresJfc().createTablePanel();
                tabbedPane.setComponentAt(PageJfcBase.this.TAB_ImageStores, panThis);
            }
            else {
                tabbedPane.addTab("Image Stores", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Image Stores");
            }
        }
        icon = Resource.getJarIcon("code.gif");
        icon = new ScaledImageIcon(icon, 32, 20);
        tabbedPane.addChangeListener(new ChangeListener() {
            volatile JPanel panThis;
            volatile Exception ex;
            ...
            public void stateChanged(ChangeEvent e) {
                if (panThis != null) return;
                if (PageJfcBase.this.TAB_Codes == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != PageJfcBase.this.TAB_Codes) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                            if (bUseCombinedDetail) panThis = getCodesJfc().createCombinedPanel();
                            else panThis = getCodesJfc().createTablePanel();
                        }
                        catch (Exception e) {
                            ex = e;
                        }
                    ...
                    protected void done() {
                        ...
                        if (panThis == null) panThis = new JPanel();
                        tp.setComponentAt(PageJfcBase.this.TAB_Codes, panThis);
                    }
                };
                sw.execute();
            }
        });
        if (getModel().getCodesModel().getCreateUI()) {
            if ((this.TAB_Codes = tabbedPane.getTabCount()) == 0) {;
                JPanel panThis;
                if (bUseCombinedDetail) panThis = getCodesJfc().createCombinedPanel();
                else panThis = getCodesJfc().createTablePanel();
                tabbedPane.setComponentAt(PageJfcBase.this.TAB_Codes, panThis);
            }
            else {
                tabbedPane.addTab("Codes", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Codes");
            }
        }
        icon = Resource.getJarIcon("classInfo.gif");
        icon = new ScaledImageIcon(icon, 32, 20);
        pan = getReferenceClassInfosJfc().createReadOnlyTablePanel();
        if (getModel().getReferenceClassInfosModel().getCreateUI()) {
            this.TAB_ReferenceClassInfos = tabbedPane.getTabCount();
            tabbedPane.addTab("Reference Class Infos", icon, pan, null);
        }
        panel = panMain;
        return panel;
    }
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcCodes != null) {
            ...
            PageJfc jfc = new PageJfc(getModel());
        ...
        final Hub<Page> hub = new Hub<Page>(Page.class);
        hub.setSharedHub(PageJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(PageJfcBase.this.getModel().getHub(), true);
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), Page.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), Page.P_Created, 15);
    ...
    public OALabel createSeqLabel() {
        OALabel lbl = new OALabel(getHub(), Page.P_Seq, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), Page.P_Name, 20);
    ...
    public OAPanel createDocHTMLTextPanel() {
        OAHTMLTextPane txthtml = createDocHTMLTextPane();
    ...
    public OAHTMLTextPane createDocHTMLTextPane() {
        OAHTMLTextPane html = new OAHTMLTextPane(getHub(), Page.P_Doc);
        html.setSpellChecker(Resource.getSpellChecker());
        html.setPreferredSize(10,  30);
        // need to create a place to have the images stored
        html.createImageHandler(getHub(), Page.P_ImageStores, ImageStore.P_Bytes, ImageStore.P_OrigFileName, ImageStore.P_Id);    return html;
    }
    public OALabel createDocLabel() {
        OALabel lbl = new OALabel(getHub(), Page.P_Doc, 20);
        lbl.setVerticalAlignment(SwingConstants.TOP);
        return lbl;
    }
    
    public OALabel createClassInfoLabel() {
        OALabel lbl = getClassInfoJfc().createLabel();
        return lbl;
    }
    public JButton createClassInfoCommand() {
        JButton cmd = null;
        cmd = getClassInfoJfc().createGotoEditButton();
        return cmd;
    }
    
    public OALabel createSectionLabel() {
        OALabel lbl = getSectionJfc().createLabel();
        return lbl;
    }
    public JButton createSectionCommand() {
        JButton cmd = null;
        cmd = getSectionJfc().createGotoEditButton();
        return cmd;
    }
    ...
    public ClassInfoJfc getClassInfoJfc() {
        if (jfcClassInfo != null) return jfcClassInfo;
        jfcClassInfo = new ClassInfoJfc(getModel().getClassInfoModel()) {
        };
        jfcClassInfo.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcClassInfo, this);
        return jfcClassInfo;
    }
    public SectionJfc getSectionJfc() {
        if (jfcSection != null) return jfcSection;
        jfcSection = new SectionJfc(getModel().getSectionModel()) {
        };
        jfcSection.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcSection, this);
        return jfcSection;
    }
    public CodeJfc getCodesJfc() {
        if (jfcCodes == null) {
            jfcCodes = createCodesJfc();
        }
        return jfcCodes;
    }
    public CodeJfc createCodesJfc() {
        jfcCodes = new CodeJfc(getModel().getCodesModel()) {
            @Override
            public JPanel getCardPanel() {
                if (cardPanel != null) return cardPanel;
                cardPanel = new JPanel(getCardLayout());
            ...
            public void showCardPanel(String name) {
                if (name.equals(CodeJfc.CARD_List)) {
                    PageJfcBase.this.showCardPanel(CARD_Edit);
                    if (PageJfcBase.this.TAB_Codes >= 0) {
                        PageJfcBase.this.getTabbedPane().setSelectedIndex(PageJfcBase.this.TAB_Codes);
                    }
                }
                else if (name.equals(CodeJfcBase.CARD_Edit)) {
                    PageJfcBase.this.showCardPanel(CARD_Edit);
                    if (PageJfcBase.this.TAB_Codes >= 0) {
                        PageJfcBase.this.getTabbedPane().setSelectedIndex(PageJfcBase.this.TAB_Codes);
                    }
                    ...
                    PageJfcBase.this.showCardPanel(CARD_Codes);
            ...
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + PageJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        PageJfcBase.this.showCardPanel(PageJfcBase.this.CARD_Edit);
                        PageJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
        ...
        jfcCodes.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcCodes, this);
        return jfcCodes;
    }
    public ImageStoreJfc getImageStoresJfc() {
        if (jfcImageStores == null) {
            jfcImageStores = createImageStoresJfc();
        }
        return jfcImageStores;
    }
    public ImageStoreJfc createImageStoresJfc() {
        jfcImageStores = new ImageStoreJfc(getModel().getImageStoresModel()) {
            @Override
            protected ImageStoreSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                ImageStoreSearchModel model = PageJfcBase.this.getModel().getImageStoresSearchModel();
                jfcSearch = new ImageStoreSearchJfc(model, true, false);
                return jfcSearch;
            }
            @Override
            public JPanel getCardPanel() {
            ...
            @Override
            public void showCardPanel(String name) {
                if (name.equals(ImageStoreJfc.CARD_List)) {
                    PageJfcBase.this.showCardPanel(CARD_Edit);
                    if (PageJfcBase.this.TAB_ImageStores >= 0) {
                        PageJfcBase.this.getTabbedPane().setSelectedIndex(PageJfcBase.this.TAB_ImageStores);
                    }
                }
                else if (name.equals(ImageStoreJfcBase.CARD_Edit)) {
                    PageJfcBase.this.showCardPanel(CARD_Edit);
                    if (PageJfcBase.this.TAB_ImageStores >= 0) {
                        PageJfcBase.this.getTabbedPane().setSelectedIndex(PageJfcBase.this.TAB_ImageStores);
                    }
                    ...
                    PageJfcBase.this.showCardPanel(CARD_ImageStores);
                    super.showCardPanel(name);
                }
            }
            public JButton createGoBackButton() {
        ...
        jfcImageStores.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcImageStores, this);
        return jfcImageStores;
    }
    public ClassInfoJfc getReferenceClassInfosJfc() {
        if (jfcReferenceClassInfos == null) {
            jfcReferenceClassInfos = createReferenceClassInfosJfc();
        }
        return jfcReferenceClassInfos;
    }
    public ClassInfoJfc createReferenceClassInfosJfc() {
        jfcReferenceClassInfos = new ClassInfoJfc(getModel().getReferenceClassInfosModel()) {
            @Override
            protected ClassInfoSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                ClassInfoSearchModel model = PageJfcBase.this.getModel().getReferenceClassInfosSearchModel();
                jfcSearch = new ClassInfoSearchJfc(model, true, false);
                return jfcSearch;
            }
            @Override
            public JPanel getCardPanel() {
            ...
            public void showCardPanel(String name) {
                if (name.equals(ClassInfoJfc.CARD_List)) {
                    PageJfcBase.this.showCardPanel(CARD_Edit);
                    if (PageJfcBase.this.TAB_ReferenceClassInfos >= 0) {
                        PageJfcBase.this.getTabbedPane().setSelectedIndex(PageJfcBase.this.TAB_ReferenceClassInfos);
                    }
                }
                    ...
                    PageJfcBase.this.showCardPanel(CARD_ReferenceClassInfos);
                    super.showCardPanel(name);
                }
            }
            public JButton createGoBackButton() {
        ...
        jfcReferenceClassInfos.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcReferenceClassInfos, this);
        return jfcReferenceClassInfos;
    }
    // OnShowCommands
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_Codes)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getCodesJfc().getCardPanel()) ) {
                cardPanel.add(getCodesJfc().getCardPanel(), CARD_Codes);
            }
        }
        else if (name.equalsIgnoreCase(CARD_ImageStores)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getImageStoresJfc().getCardPanel()) ) {
                cardPanel.add(getImageStoresJfc().getCardPanel(), CARD_ImageStores);
            }
        }
        else if (name.equalsIgnoreCase(CARD_ReferenceClassInfos)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getReferenceClassInfosJfc().getCardPanel()) ) {
                cardPanel.add(getReferenceClassInfosJfc().getCardPanel(), CARD_ReferenceClassInfos);
            }
        }
    ...
    protected void onNewPageCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public PageSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        PageSearchModel modelSearch = new PageSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new PageSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (Page page : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(page)) {
                    getModel().getMultiSelectHub().add(page);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            Page page = getSearchHubJfc().getSelected();
            if (page != null) {
                if (getHub().contains(page)) {
                    getHub().setAO(page);
                }
    ...
    // Search
    protected PageSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new PageSearchJfc();
        }
        return jfcSearch;
    }
    protected Page onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        Page page = null;
        if (getSearchJfc().wasSelected()) page = getSearchJfc().getSelected();
        return page;
    }
    // Add
    protected PageSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new PageSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        Page page = getAddJfc().getSelected();
        if (page == null) return;
        getHub().add(page);
        getHub().setAO(page);
    }
    ...
    public static void main(String[] args) {
        ...
        PageJfc ui = new PageJfc() {
            @Override
            protected PageSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new PageSearchJfc(false) {
                        @Override
