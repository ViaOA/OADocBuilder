...
import com.viaoa.docbuilder.model.oa.Section;
...
public class SectionJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(SectionJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(Section.P_Name);
    ...
    protected static final String CARD_Sections = "Sections";
    protected int TAB_Sections = -1;
    ...
    // Search
    protected SectionSearchJfc jfcSearch;
    // hub Search
    protected SectionSearchJfc jfcSearchHub;
    // Add
    protected SectionSearchJfc jfcAdd;
    ...
    protected SectionJfc jfcParentSection;
    protected TutorialJfc jfcTutorial;
    protected SectionJfc jfcSections;
    
    public SectionJfcBase() {
        this.model = new SectionModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public SectionJfcBase(Hub<Section> hubSection) {
        this.model = new SectionModel(hubSection);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public SectionJfcBase(SectionModel modelSection) {
        if (modelSection == null) this.model = new SectionModel();
        else this.model = modelSection;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("section.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("sections.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<Section> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // SectionJfcBase.this.getEditDialog(this).setVisible(true);
                SectionJfcBase.this.onNewSectionCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<Section> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<Section> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getRootHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, Section.P_Name), hubRoot, getModel().getRecursiveHub()) {
            @Override
            public void objectSelected(Object obj) {
                SectionJfcBase.this.getModel().setType(SectionModel.TYPE_Recursive);
                super.objectSelected(obj);
                SectionJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                SectionJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
        ...
        if (!bIncludeChildren) {
            node.add(node, Section.P_Sections);
            return node;
        }
    ...
    public JPopupMenu createTreeNodePopupMenu(OATreeNode tn) {
        ...
        OAMenuItem mi;
        mi = getSectionsJfc().createNewMenuItem();
        if (mi != null) menu.add(mi);
        mi = getSectionsJfc().createAddMenuItem();
        if (mi != null) menu.add(mi);
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                Section section = SectionJfcBase.this.onSearch();
                return section;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(Section.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                SectionJfcBase.this.customizeRenderer(lbl, SectionJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return SectionJfcBase.this.getToolTipText(SectionJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, Section section, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(Section section, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(Section.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                SectionJfcBase.this.customizeRenderer(lbl, SectionJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(Section.P_Name), 12, 20) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                SectionJfcBase.this.customizeRenderer(label, SectionJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createRecursiveTree() {
        ...
        if (mi != null) {
            ...
            menu.add(new OAMenuItem(getHub().getDetailHub(Section.P_Sections), OAMenuItem.PASTE, "Paste inside"));
    ...
    public OATable createRecursiveTreeTable() {
        ...
        tree.add(node);
        node.add(node, Section.P_Sections); // make recursive
        
        OATable table = new OATable(getModel().getTreeTableHub());
        table.setAllowDnD(false);
        table.setAllowSorting(false);
        // table.setColumnProperties(ModelDelegate.getProperties(), "Section");
        
        table.addColumn("Section", 27, tree);
        SectionJfc sectionJfc = new SectionJfc(getModel().getTreeTableHub());
        sectionJfc.createTableColumns(table);
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(SectionJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(PP_Display, getModel().getRootHub(), getModel().getRecursiveHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
        ...
        node.setIcon(SectionJfc.getIcon());
        node.setForegroundColorProperty(SectionJfc.PP_ForeColor);
        node.setBackgroundColorProperty(SectionJfc.PP_BackColor);
        node.setIconColorProperty(SectionJfc.PP_IconColor);
        node.setImageProperty(SectionJfc.PP_Icon);
        node.setFontProperty(SectionJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // Section client = (Section) table.getHub().getAt(row);
        // defaultValue = SectionDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<Section> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<Section>(Section.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (SectionJfcBase.this.getModel().getAllowGotoEdit()) {
                    SectionJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Section.P_Id));
        }
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Section.P_Name));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), Section.P_Id, 6);
        tc = table.addColumn("Id", 6, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Section.P_Id));
        }
        lbl = new OALabel(getHub(), Section.P_Created, 15);
        tc = table.addColumn("Created", 15, lbl);
        lbl = new OALabel(getHub(), Section.P_Name, 20);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(Section.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(Section.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.showCardPanel(SectionJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<Section>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", Section.P_Id);
        dd.addProperty("id", Section.P_Id);
        dd.addProperty("created", Section.P_Created);
        dd.addProperty("name", Section.P_Name);
    }
    // Card Panel
    ...
    public JPanel createEditCardPanel(JTabbedPane tp) {
        ...
        // cardPanel.add(getSectionsJfc().getCardPanel(), CARD_Sections); // this will be created when needed by showCardPanel(..)
        return pan;
    }
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
        if (getModel().getTutorialModel().getCreateUI()) {
            lbl = new JLabel("Tutorial:");
            gc.anchor = gc.WEST;
            panel.add(lbl, gc);
            gc.anchor = gc.NORTHWEST;
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createTutorialLabel();
            if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
            OAJfcControllerFactory.createOnlyAoNotNull(getHub(), lbl);
            cmd = createTutorialCommand();
            comp = olbl;
        ...
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
        if (getModel().getParentSectionModel().getCreateUI()) {
            lbl = new JLabel("Parent Section:");
            gc.anchor = gc.WEST;
            panel.add(lbl, gc);
            gc.anchor = gc.NORTHWEST;
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createParentSectionLabel();
            if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
            OAJfcControllerFactory.createOnlyAoNotNull(getHub(), lbl);
            cmd = createParentSectionCommand();
            comp = olbl;
            comp = new OAResizePanel(comp, cmd);
            panel.add(comp, gc);
            gc.gridwidth = 1;
        ...
        Icon icon;
        icon = Resource.getJarIcon("section.gif");
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (SectionJfcBase.this.TAB_Sections == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != SectionJfcBase.this.TAB_Sections) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                            if (bUseCombinedDetail) panThis = getSectionsJfc().createCombinedPanel();
                            else panThis = getSectionsJfc().createDetailTableCardPanel();
                        }
                        catch (Exception e) {
                            ex = e;
                        }
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for Section", ex);
                        ...
                        tp.setComponentAt(SectionJfcBase.this.TAB_Sections, panThis);
                    }
                };
                sw.execute();
            }
        });
        if (getModel().getSectionsModel().getCreateUI()) {
            if ((this.TAB_Sections = tabbedPane.getTabCount()) == 0) {;
                JPanel panThis;
                if (bUseCombinedDetail) panThis = getSectionsJfc().createCombinedPanel();
                else panThis = getSectionsJfc().createDetailTableCardPanel();
                tabbedPane.setComponentAt(SectionJfcBase.this.TAB_Sections, panThis);
            }
            else {
                tabbedPane.addTab("Sections", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Sections");
            }
        }
        panel = panMain;
        return panel;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcSections != null) {
            ...
            SectionJfc jfc = new SectionJfc(getModel());
        ...
        final Hub<Section> hub = new Hub<Section>(Section.class);
        hub.setSharedHub(SectionJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(SectionJfcBase.this.getModel().getHub(), true);
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), Section.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), Section.P_Created, 15);
    ...
    public OALabel createSeqLabel() {
        OALabel lbl = new OALabel(getHub(), Section.P_Seq, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), Section.P_Name, 20);
    ...
    public OALabel createParentSectionLabel() {
        OALabel lbl = getParentSectionJfc().createLabel();
        return lbl;
    }
    public JButton createParentSectionCommand() {
        JButton cmd = null;
        cmd = getParentSectionJfc().createGotoEditButton();
        return cmd;
    }
    
    public OALabel createTutorialLabel() {
        OALabel lbl = getTutorialJfc().createLabel();
        return lbl;
    }
    public JButton createTutorialCommand() {
        JButton cmd = null;
        return null;
    }
    ...
    public SectionJfc getParentSectionJfc() {
        if (jfcParentSection != null) return jfcParentSection;
        jfcParentSection = new SectionJfc(getModel().getParentSectionModel()) {
        };
        jfcParentSection.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcParentSection, this);
        return jfcParentSection;
    }
    public TutorialJfc getTutorialJfc() {
        if (jfcTutorial != null) return jfcTutorial;
        jfcTutorial = new TutorialJfc(getModel().getTutorialSelectFromModel()) {
        };
        jfcTutorial.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcTutorial, this);
        return jfcTutorial;
    }
    public SectionJfc getSectionsJfc() {
        if (jfcSections == null) {
            jfcSections = createSectionsJfc();
        }
        return jfcSections;
    }
    public SectionJfc createSectionsJfc() {
        jfcSections = new SectionJfc(getModel().getSectionsModel()) {
            @Override
            public JPanel getCardPanel() {
                if (cardPanel != null) return cardPanel;
                cardPanel = new JPanel(getCardLayout());
            ...
            public void showCardPanel(String name) {
                if (name.equals(SectionJfc.CARD_List)) {
                    SectionJfcBase.this.showCardPanel(CARD_Edit);
                    if (SectionJfcBase.this.TAB_Sections >= 0) {
                        SectionJfcBase.this.getTabbedPane().setSelectedIndex(SectionJfcBase.this.TAB_Sections);
                    }
                }
                else if (name.equals(SectionJfcBase.CARD_Edit)) {
                    SectionJfcBase.this.showCardPanel(CARD_Edit);
                    if (SectionJfcBase.this.TAB_Sections >= 0) {
                        SectionJfcBase.this.getTabbedPane().setSelectedIndex(SectionJfcBase.this.TAB_Sections);
                    }
                    ...
                    SectionJfcBase.this.showCardPanel(CARD_Sections);
            ...
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + SectionJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        SectionJfcBase.this.showCardPanel(SectionJfcBase.this.CARD_Edit);
                        SectionJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
        ...
        getModel().getSectionsModel().setType(SectionModel.TYPE_TreeTable);
        jfcSections.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcSections, this);
        return jfcSections;
    }
    // OnShowCommands
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_Sections)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getSectionsJfc().getCardPanel()) ) {
                cardPanel.add(getSectionsJfc().getCardPanel(), CARD_Sections);
            }
        }
    ...
    protected void onNewSectionCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public SectionSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        SectionSearchModel modelSearch = new SectionSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new SectionSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (Section section : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(section)) {
                    getModel().getMultiSelectHub().add(section);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            Section section = getSearchHubJfc().getSelected();
            if (section != null) {
                if (getHub().contains(section)) {
                    getHub().setAO(section);
                }
            }
        }
    }
    // Search
    protected SectionSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new SectionSearchJfc();
        }
        return jfcSearch;
    }
    protected Section onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        Section section = null;
        if (getSearchJfc().wasSelected()) section = getSearchJfc().getSelected();
        return section;
    }
    // Add
    protected SectionSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new SectionSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        Section section = getAddJfc().getSelected();
    ...
    public JButton createOriginalTableButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.getModel().setType(SectionModel.TYPE_Original);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createRootTableButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.getModel().setType(SectionModel.TYPE_Root);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createTreeTableButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.getModel().setType(SectionModel.TYPE_TreeTable);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createFlattenedTableButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SectionJfcBase.this.getModel().setType(SectionModel.TYPE_Flattened);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public static void main(String[] args) {
        ...
        SectionJfc ui = new SectionJfc() {
            @Override
            protected SectionSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new SectionSearchJfc(false) {
                        @Override
