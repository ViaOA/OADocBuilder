...
public class PackageInfoJfc extends PackageInfoJfcBase {
    
    public PackageInfoJfc() {
    }
    
    public PackageInfoJfc(Hub<PackageInfo> hubPackageInfo) {
        super(hubPackageInfo);
    }
    
    public PackageInfoJfc(PackageInfoModel modelPackageInfo) {
        super(modelPackageInfo);
    }
