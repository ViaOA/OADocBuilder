...
import com.viaoa.docbuilder.model.oa.ImageStore;
...
public class ImageStoreJfcBase implements OAModelJfcInterface {
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        lbl = new JLabel("Drawio Link:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        txt = createDrawioLinkTextField();
        if (getModel().getViewOnly()) txt.getController().setViewOnly(true);
        txt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        final Hub<ImageStore> hub = new Hub<ImageStore>(ImageStore.class);
        hub.setSharedHub(ImageStoreJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(ImageStoreJfcBase.this.getModel().getHub(), true);
    ...
    public OATextField createDrawioLinkTextField() {
        OATextField txt = new OATextField(getHub(), ImageStore.P_DrawioLink, 25);
        txt.setMinimumColumns(0);
        txt.setMaximumColumns(120);
        // setup(txt);
        return txt;
