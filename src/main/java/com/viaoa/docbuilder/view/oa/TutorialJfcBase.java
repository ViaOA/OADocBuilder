...
import com.viaoa.docbuilder.model.oa.Tutorial;
...
public class TutorialJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(TutorialJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(Tutorial.P_Name);
    ...
    // Search
    protected TutorialSearchJfc jfcSearch;
    // hub Search
    protected TutorialSearchJfc jfcSearchHub;
    // Add
    protected TutorialSearchJfc jfcAdd;
    ...
    public TutorialJfcBase() {
        this.model = new TutorialModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public TutorialJfcBase(Hub<Tutorial> hubTutorial) {
        this.model = new TutorialModel(hubTutorial);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public TutorialJfcBase(TutorialModel modelTutorial) {
        if (modelTutorial == null) this.model = new TutorialModel();
        else this.model = modelTutorial;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("tutorial.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("tutorials.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<Tutorial> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // TutorialJfcBase.this.getEditDialog(this).setVisible(true);
                TutorialJfcBase.this.onNewTutorialCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<Tutorial> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<Tutorial> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, Tutorial.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                TutorialJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                TutorialJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
        ...
        OATreeTitleNode ttn;
        OATreeNode node2;
        ttn = getSectionsJfc().getTreeTitleNode();
        node2 = findNode(Tutorial.P_Sections, parentNodes);
        if (node2 == null) {
            node2 = getSectionsJfc().createTreeNode(Tutorial.P_Sections, null, true, nodes);
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                Tutorial tutorial = TutorialJfcBase.this.onSearch();
                return tutorial;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                TutorialJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(Tutorial.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                TutorialJfcBase.this.customizeRenderer(lbl, TutorialJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return TutorialJfcBase.this.getToolTipText(TutorialJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, Tutorial tutorial, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(Tutorial tutorial, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(Tutorial.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                TutorialJfcBase.this.customizeRenderer(lbl, TutorialJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(Tutorial.P_Name), 12, 20) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                TutorialJfcBase.this.customizeRenderer(label, TutorialJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(TutorialJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(TutorialJfc.PP_Display, ModelDelegate.getTutorials().createSharedHub(), getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                TutorialJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(TutorialJfc.getIcon());
        node.setForegroundColorProperty(TutorialJfc.PP_ForeColor);
        node.setBackgroundColorProperty(TutorialJfc.PP_BackColor);
        node.setIconColorProperty(TutorialJfc.PP_IconColor);
        node.setImageProperty(TutorialJfc.PP_Icon);
        node.setFontProperty(TutorialJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // Tutorial client = (Tutorial) table.getHub().getAt(row);
        // defaultValue = TutorialDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<Tutorial> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<Tutorial>(Tutorial.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (TutorialJfcBase.this.getModel().getAllowGotoEdit()) {
                    TutorialJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "Tutorial");
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Tutorial.P_Id));
        }
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Tutorial.P_Name));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), Tutorial.P_Id, 6);
        tc = table.addColumn("Id", 6, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(Tutorial.P_Id));
        }
        lbl = new OALabel(getHub(), Tutorial.P_Created, 15);
        tc = table.addColumn("Created", 15, lbl);
        lbl = new OALabel(getHub(), Tutorial.P_Name, 20);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(Tutorial.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(Tutorial.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                TutorialJfcBase.this.showCardPanel(TutorialJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                TutorialJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<Tutorial>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", Tutorial.P_Id);
        dd.addProperty("id", Tutorial.P_Id);
        dd.addProperty("created", Tutorial.P_Created);
        dd.addProperty("name", Tutorial.P_Name);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (TutorialJfcBase.this.TAB_Sections == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != TutorialJfcBase.this.TAB_Sections) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for Tutorial", ex);
                        ...
                        tp.setComponentAt(TutorialJfcBase.this.TAB_Sections, panThis);
                    }
                };
                sw.execute();
            }
        ...
        if (getModel().getSectionsModel().getCreateUI()) {
            if ((this.TAB_Sections = tabbedPane.getTabCount()) == 0) {;
                ...
                tabbedPane.setComponentAt(TutorialJfcBase.this.TAB_Sections, panThis);
            }
            else {
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcSections != null) {
            ...
            TutorialJfc jfc = new TutorialJfc(getModel());
        ...
        final Hub<Tutorial> hub = new Hub<Tutorial>(Tutorial.class);
        hub.setSharedHub(TutorialJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(TutorialJfcBase.this.getModel().getHub(), true);
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), Tutorial.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), Tutorial.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), Tutorial.P_Name, 20);
        ...
        jfcSections = new SectionJfc(getModel().getSectionsModel()) {
            ...
            public void showCardPanel(String name) {
                if (name.equals(SectionJfc.CARD_List)) {
                    TutorialJfcBase.this.showCardPanel(CARD_Edit);
                    if (TutorialJfcBase.this.TAB_Sections >= 0) {
                        TutorialJfcBase.this.getTabbedPane().setSelectedIndex(TutorialJfcBase.this.TAB_Sections);
                    }
                }
                    ...
                    TutorialJfcBase.this.showCardPanel(CARD_Sections);
            ...
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + TutorialJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        TutorialJfcBase.this.showCardPanel(TutorialJfcBase.this.CARD_Edit);
                        TutorialJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
    ...
    protected void onNewTutorialCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public TutorialSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        TutorialSearchModel modelSearch = new TutorialSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new TutorialSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (Tutorial tutorial : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(tutorial)) {
                    getModel().getMultiSelectHub().add(tutorial);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            Tutorial tutorial = getSearchHubJfc().getSelected();
            if (tutorial != null) {
                if (getHub().contains(tutorial)) {
                    getHub().setAO(tutorial);
                }
            }
        }
    }
    // Search
    protected TutorialSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new TutorialSearchJfc();
        }
        return jfcSearch;
    }
    protected Tutorial onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        Tutorial tutorial = null;
        if (getSearchJfc().wasSelected()) tutorial = getSearchJfc().getSelected();
        return tutorial;
    }
    // Add
    protected TutorialSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new TutorialSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        Tutorial tutorial = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        TutorialJfc ui = new TutorialJfc(ModelDelegate.getTutorials().createSharedHub()) {
            @Override
            protected TutorialSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new TutorialSearchJfc(false) {
                        @Override
