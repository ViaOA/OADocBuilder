...
public class ProjectInfoJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(ProjectInfoJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(ProjectInfo.P_Name);
    ...
    // Model
    protected ProjectInfoModel model;
    ...
    // Search
    protected ProjectInfoSearchJfc jfcSearch;
    // hub Search
    protected ProjectInfoSearchJfc jfcSearchHub;
    // Add
    protected ProjectInfoSearchJfc jfcAdd;
    ...
    public ProjectInfoJfcBase() {
        this.model = new ProjectInfoModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public ProjectInfoJfcBase(Hub<ProjectInfo> hubProjectInfo) {
        this.model = new ProjectInfoModel(hubProjectInfo);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public ProjectInfoJfcBase(ProjectInfoModel modelProjectInfo) {
        if (modelProjectInfo == null) this.model = new ProjectInfoModel();
        else this.model = modelProjectInfo;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("projectInfo.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("projectInfos.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<ProjectInfo> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // ProjectInfoJfcBase.this.getEditDialog(this).setVisible(true);
                ProjectInfoJfcBase.this.onNewProjectInfoCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<ProjectInfo> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<ProjectInfo> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, ProjectInfo.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                ProjectInfoJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ProjectInfoJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
        ...
        OATreeTitleNode ttn;
        OATreeNode node2;
        ttn = getPackageInfosJfc().getTreeTitleNode();
        node2 = findNode(ProjectInfo.P_PackageInfos, parentNodes);
        if (node2 == null) {
            node2 = getPackageInfosJfc().createTreeNode(ProjectInfo.P_PackageInfos, null, true, nodes);
    ...
    public JPopupMenu createTreeNodePopupMenu(OATreeNode tn) {
        ...
        OAMenuItem mi;
        mi = getPackageInfosJfc().createNewMenuItem();
        if (mi != null) menu.add(mi);
        mi = getPackageInfosJfc().createAddMenuItem();
        if (mi != null) menu.add(mi);
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                ProjectInfo projectInfo = ProjectInfoJfcBase.this.onSearch();
                return projectInfo;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ProjectInfoJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(ProjectInfo.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ProjectInfoJfcBase.this.customizeRenderer(lbl, ProjectInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return ProjectInfoJfcBase.this.getToolTipText(ProjectInfoJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, ProjectInfo projectInfo, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(ProjectInfo projectInfo, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(ProjectInfo.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ProjectInfoJfcBase.this.customizeRenderer(lbl, ProjectInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(ProjectInfo.P_Name), 12, 20) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                ProjectInfoJfcBase.this.customizeRenderer(label, ProjectInfoJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(ProjectInfoJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(ProjectInfoJfc.PP_Display, ModelDelegate.getProjectInfos().createSharedHub(), getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ProjectInfoJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(ProjectInfoJfc.getIcon());
        node.setForegroundColorProperty(ProjectInfoJfc.PP_ForeColor);
        node.setBackgroundColorProperty(ProjectInfoJfc.PP_BackColor);
        node.setIconColorProperty(ProjectInfoJfc.PP_IconColor);
        node.setImageProperty(ProjectInfoJfc.PP_Icon);
        node.setFontProperty(ProjectInfoJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // ProjectInfo client = (ProjectInfo) table.getHub().getAt(row);
        // defaultValue = ProjectInfoDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<ProjectInfo> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<ProjectInfo>(ProjectInfo.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (ProjectInfoJfcBase.this.getModel().getAllowGotoEdit()) {
                    ProjectInfoJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "ProjectInfo");
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ProjectInfo.P_Id));
        }
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ProjectInfo.P_Name));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), ProjectInfo.P_Id, 6);
        tc = table.addColumn("Id", 6, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ProjectInfo.P_Id));
        }
        lbl = new OALabel(getHub(), ProjectInfo.P_Created, 15);
        tc = table.addColumn("Created", 15, lbl);
        lbl = new OALabel(getHub(), ProjectInfo.P_Name, 20);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(ProjectInfo.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(ProjectInfo.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public void addCustomCommands(JToolBar toolBar) {
        ...
        toolBar.add(createProjectInfoLoadClassesMethodButton());
    }
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ProjectInfoJfcBase.this.showCardPanel(ProjectInfoJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ProjectInfoJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<ProjectInfo>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", ProjectInfo.P_Id);
        dd.addProperty("id", ProjectInfo.P_Id);
        dd.addProperty("created", ProjectInfo.P_Created);
        dd.addProperty("name", ProjectInfo.P_Name);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        opan = createDirectoryPanel();
        if (getModel().getViewOnly()) opan.getController().setViewOnly(true);
        opan.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
        comp = new OAResizePanel(opan, 95);
        panel.add(comp, gc);
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (ProjectInfoJfcBase.this.TAB_PackageInfos == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != ProjectInfoJfcBase.this.TAB_PackageInfos) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                            if (bUseCombinedDetail) panThis = getPackageInfosJfc().createCombinedPanel();
                            else panThis = getPackageInfosJfc().createDetailTableCardPanel();
                        }
                        catch (Exception e) {
                            ex = e;
                        }
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for ProjectInfo", ex);
                        ...
                        tp.setComponentAt(ProjectInfoJfcBase.this.TAB_PackageInfos, panThis);
                    }
                };
                sw.execute();
            }
        ...
        if (getModel().getPackageInfosModel().getCreateUI()) {
            if ((this.TAB_PackageInfos = tabbedPane.getTabCount()) == 0) {;
                JPanel panThis;
                if (bUseCombinedDetail) panThis = getPackageInfosJfc().createCombinedPanel();
                else panThis = getPackageInfosJfc().createDetailTableCardPanel();
                tabbedPane.setComponentAt(ProjectInfoJfcBase.this.TAB_PackageInfos, panThis);
            }
            else {
                tabbedPane.addTab("Package Infos", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Package Infos");
            }
        }
        panel = panMain;
        return panel;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcPackageInfos != null) {
            ...
            ProjectInfoJfc jfc = new ProjectInfoJfc(getModel());
        ...
        final Hub<ProjectInfo> hub = new Hub<ProjectInfo>(ProjectInfo.class);
        hub.setSharedHub(ProjectInfoJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(ProjectInfoJfcBase.this.getModel().getHub(), true);
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), ProjectInfo.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), ProjectInfo.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), ProjectInfo.P_Name, 20);
    ...
    public OATextField createDirectoryTextField() {
        OATextField txt = new OATextField(getHub(), ProjectInfo.P_Directory, 32);
        txt.setMinimumColumns(0);
        txt.setMaximumColumns(120);
        // setup(txt);
        return txt;
    }
    public OAPanel createDirectoryPanel() {
        OAPanel pan = new OAPanel(getHub(), new FlowLayout(FlowLayout.LEFT, 2, 0));
        pan.add(createDirectoryTextField());
        pan.add(createDirectoryFileChooserButton());
        return pan;
    }
    public OAButton createDirectoryFileChooserButton() {
        final OAFileChooser fc = createDirectoryFileChooser();
        OAButton cmd = new OAButton(getHub(), "Choose Directory ...", Resource.getJarIcon(Resource.IMG_OpenFile)) {
            @Override
            protected boolean onActionPerformed() {
                int x = fc.showOpenDialog(this);
                if (x != JFileChooser.APPROVE_OPTION) return false;
                File file = fc.getSelectedFile();
                if (file == null) return false;
                String fn = file.getPath();
                ProjectInfo projectInfo = ProjectInfoJfcBase.this.getHub().getAO();
                projectInfo.setDirectory(fn);
                return true;
            }
        };
        cmd.setToolTipText("select file");
        OAButton.setup(cmd);
        return cmd;
    }
    public OAFileChooser createDirectoryFileChooser() {
    ...
    public OALabel createDirectoryLabel() {
        OALabel lbl = new OALabel(getHub(), ProjectInfo.P_Directory, 20);
        return lbl;
    }
    
    public OAConsole createConsoleConsole() {
        OAConsole con = new OAConsole(getHub(), ProjectInfo.P_Console, 20);
        return con;
    }
    
    public OAButton createProjectInfoLoadClassesMethodButton() {
        OAButton cmd = new OAButton(getHub(), "Load Classes ...", getModel().getAllowMultiSelect() ? ButtonCommand.HubMethod : ButtonCommand.ObjectMethod) { 
            @Override
            public boolean onActionPerformed() {
                if (ProjectInfoJfcBase.this.getModel().getAllowMultiSelect() && ProjectInfoJfcBase.this.getModel().getMultiSelectHub().getSize() > 0) {
                    for (ProjectInfo projectInfo : ProjectInfoJfcBase.this.getModel().getMultiSelectHub()) {
                        if (!performAction(projectInfo)) return false;
                    }
                }
                else {
                    ProjectInfo projectInfo = ProjectInfoJfcBase.this.getHub().getAO();
                    performAction(projectInfo);
                }
                return true;
            }
            boolean performAction(ProjectInfo projectInfo) {
                if (projectInfo == null) return false;
                projectInfo.loadClasses();
                return true;
            }
        };
        cmd.setIcon(Resource.getJarIcon("command16.png"));
        cmd.setConfirmMessage("OK to find packages & classes");
        cmd.setUseSwingWorker(true);
        cmd.setProcessingText("Load Classes", "Processing ...");
        cmd.setConsoleProperty(ProjectInfoPP.console());
        cmd.setMethodName(ProjectInfo.M_LoadClasses);
        cmd.setCompletedMessage("Completed");
        cmd.setToolTipText("scan source code in directory to find all packages and classes");
        cmd.setup();
        return cmd;
    }
        ...
        jfcPackageInfos = new PackageInfoJfc(getModel().getPackageInfosModel()) {
            ...
            public void showCardPanel(String name) {
                if (name.equals(PackageInfoJfc.CARD_List)) {
                    ProjectInfoJfcBase.this.showCardPanel(CARD_Edit);
                    if (ProjectInfoJfcBase.this.TAB_PackageInfos >= 0) {
                        ProjectInfoJfcBase.this.getTabbedPane().setSelectedIndex(ProjectInfoJfcBase.this.TAB_PackageInfos);
                    }
                }
                    ...
                    ProjectInfoJfcBase.this.showCardPanel(CARD_PackageInfos);
            ...
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + ProjectInfoJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        ProjectInfoJfcBase.this.showCardPanel(ProjectInfoJfcBase.this.CARD_Edit);
                        ProjectInfoJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
    ...
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_PackageInfos)) {
    ...
    protected void onNewProjectInfoCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public ProjectInfoSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        ProjectInfoSearchModel modelSearch = new ProjectInfoSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new ProjectInfoSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (ProjectInfo projectInfo : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(projectInfo)) {
                    getModel().getMultiSelectHub().add(projectInfo);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            ProjectInfo projectInfo = getSearchHubJfc().getSelected();
            if (projectInfo != null) {
                if (getHub().contains(projectInfo)) {
                    getHub().setAO(projectInfo);
                }
            }
        }
    }
    ...
    protected ProjectInfoSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new ProjectInfoSearchJfc();
        }
        return jfcSearch;
    }
    protected ProjectInfo onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        ProjectInfo projectInfo = null;
        if (getSearchJfc().wasSelected()) projectInfo = getSearchJfc().getSelected();
        return projectInfo;
    }
    // Add
    protected ProjectInfoSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new ProjectInfoSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        ProjectInfo projectInfo = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        ProjectInfoJfc ui = new ProjectInfoJfc(ModelDelegate.getProjectInfos().createSharedHub()) {
            @Override
            protected ProjectInfoSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new ProjectInfoSearchJfc(false) {
                        @Override
