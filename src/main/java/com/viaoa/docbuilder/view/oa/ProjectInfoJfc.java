...
public class ProjectInfoJfc extends ProjectInfoJfcBase {
    
    public ProjectInfoJfc() {
    }
    
    public ProjectInfoJfc(Hub<ProjectInfo> hubProjectInfo) {
        super(hubProjectInfo);
    }
    
    public ProjectInfoJfc(ProjectInfoModel modelProjectInfo) {
        super(modelProjectInfo);
    }
