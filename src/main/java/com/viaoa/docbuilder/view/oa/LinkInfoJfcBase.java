...
import com.viaoa.docbuilder.model.oa.LinkInfo;
...
public class LinkInfoJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(LinkInfoJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(LinkInfo.P_Id);
    ...
    // Search
    protected LinkInfoSearchJfc jfcSearch;
    // hub Search
    protected LinkInfoSearchJfc jfcSearchHub;
    // Add
    protected LinkInfoSearchJfc jfcAdd;
    ...
    public LinkInfoJfcBase() {
        this.model = new LinkInfoModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public LinkInfoJfcBase(Hub<LinkInfo> hubLinkInfo) {
        this.model = new LinkInfoModel(hubLinkInfo);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public LinkInfoJfcBase(LinkInfoModel modelLinkInfo) {
        if (modelLinkInfo == null) this.model = new LinkInfoModel();
        else this.model = modelLinkInfo;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("linkInfo.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("linkInfos.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<LinkInfo> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // LinkInfoJfcBase.this.getEditDialog(this).setVisible(true);
                LinkInfoJfcBase.this.onNewLinkInfoCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<LinkInfo> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<LinkInfo> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, LinkInfo.P_Id), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                LinkInfoJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                LinkInfoJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                LinkInfo linkInfo = LinkInfoJfcBase.this.onSearch();
                return linkInfo;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                LinkInfoJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(LinkInfo.P_Id), 6) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                LinkInfoJfcBase.this.customizeRenderer(lbl, LinkInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return LinkInfoJfcBase.this.getToolTipText(LinkInfoJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, LinkInfo linkInfo, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(LinkInfo linkInfo, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(LinkInfo.P_Id), 6) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                LinkInfoJfcBase.this.customizeRenderer(lbl, LinkInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(LinkInfo.P_Id), 12, 6) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                LinkInfoJfcBase.this.customizeRenderer(label, LinkInfoJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(LinkInfoJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(LinkInfoJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                LinkInfoJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(LinkInfoJfc.getIcon());
        node.setForegroundColorProperty(LinkInfoJfc.PP_ForeColor);
        node.setBackgroundColorProperty(LinkInfoJfc.PP_BackColor);
        node.setIconColorProperty(LinkInfoJfc.PP_IconColor);
        node.setImageProperty(LinkInfoJfc.PP_Icon);
        node.setFontProperty(LinkInfoJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // LinkInfo client = (LinkInfo) table.getHub().getAt(row);
        // defaultValue = LinkInfoDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<LinkInfo> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<LinkInfo>(LinkInfo.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (LinkInfoJfcBase.this.getModel().getAllowGotoEdit()) {
                    LinkInfoJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "LinkInfo");
    ...
    public void createTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        tc = table.addColumn("Id", 6, new OALabel(getHub(), OAString.cpp(LinkInfo.P_Id)));
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(LinkInfo.P_Id));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), LinkInfo.P_Id, 6);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(LinkInfo.P_Id));
            lbl.setToolTipTextPropertyPath(OAString.cpp(LinkInfo.P_Id));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                LinkInfoJfcBase.this.showCardPanel(LinkInfoJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                LinkInfoJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<LinkInfo>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", LinkInfo.P_Id);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(boolean bUseCombinedDetail) {
        ...
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        txt = createDescriptionTextField();
        if (getModel().getViewOnly()) txt.getController().setViewOnly(true);
        txt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        final Hub<LinkInfo> hub = new Hub<LinkInfo>(LinkInfo.class);
        hub.setSharedHub(LinkInfoJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(LinkInfoJfcBase.this.getModel().getHub(), true);
        ...
        LinkInfoJfc jfc = new LinkInfoJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), LinkInfo.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), LinkInfo.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), LinkInfo.P_Name, 20);
    ...
    public OATextField createDescriptionTextField() {
        OATextField txt = new OATextField(getHub(), LinkInfo.P_Description, 30);
        txt.setMinimumColumns(0);
    ...
    public OATextField createLinkTextField() {
        OATextField txt = new OATextField(getHub(), LinkInfo.P_Link, 32);
        txt.setMinimumColumns(0);
        txt.setMaximumColumns(120);
        // setup(txt);
        return txt;
    ...
    public JButton createPageCommand() {
        ...
        ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
        cmd = getPageJfc().createNewButton();
        if (cmd != null) {
        ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            mscmd.addButton(cmd);
        }
        cmd = getPageJfc().createSearchButton();
        if (cmd != null) {
            ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            cmd.setText("Search ...");
            mscmd.addButton(cmd);
        ...
        Hub h;
        if (b) {
            cmd = new OAButton(getModel().getPageHub(), OAButton.CLEARAO);
            cmd.setText("Clear");
            ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            mscmd.addButton(cmd);
        }
    ...
    public PageJfc getPageJfc() {
        ...
        jfcPage = new PageJfc(getModel().getPageModel()) {
            ...
            protected PageSearchJfc getSearchJfc() {
                ...
                LinkInfoJfcBase.this.getModel().getPageSearchModel().getPageSearch().setMaxResults(1000);
                jfcSearch = new PageSearchJfc(LinkInfoJfcBase.this.getModel().getPageSearchModel());
                return jfcSearch;
            }
            @Override
            protected void onNewPageCreated() {
                getEditDialog(LinkInfoJfcBase.this.getCardPanel()).setVisible(true);
            }
            @Override
            protected Page onSearch() {
                ...
                Page page = getSearchJfc().getSelected();
                return page;
            }
        };
    ...
    protected void onNewLinkInfoCreated() {
        onShowEditPanel();
    }
    ...
    // Inner Search
    public LinkInfoSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        LinkInfoSearchModel modelSearch = new LinkInfoSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new LinkInfoSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (LinkInfo linkInfo : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(linkInfo)) {
                    getModel().getMultiSelectHub().add(linkInfo);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            LinkInfo linkInfo = getSearchHubJfc().getSelected();
            if (linkInfo != null) {
                if (getHub().contains(linkInfo)) {
                    getHub().setAO(linkInfo);
                }
            }
        }
    }
    // Search
    protected LinkInfoSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new LinkInfoSearchJfc();
        }
        return jfcSearch;
    }
    protected LinkInfo onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        LinkInfo linkInfo = null;
        if (getSearchJfc().wasSelected()) linkInfo = getSearchJfc().getSelected();
        return linkInfo;
    }
    // Add
    protected LinkInfoSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new LinkInfoSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        LinkInfo linkInfo = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        LinkInfoJfc ui = new LinkInfoJfc() {
            @Override
            protected LinkInfoSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new LinkInfoSearchJfc(false) {
                        @Override
