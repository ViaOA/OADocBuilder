...
public class ClassInfoJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(ClassInfoJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(ClassInfo.P_Name);
    ...
    // Model
    protected ClassInfoModel model;
    ...
    protected static final String CARD_ReferencePages = "ReferencePages";
    protected int TAB_ReferencePages = -1;
    protected JPanel cardPanel;
    protected CardLayout cardLayout;
    protected JTabbedPane tabbedPane;
    
    // Search
    protected ClassInfoSearchJfc jfcSearch;
    // hub Search
    protected ClassInfoSearchJfc jfcSearchHub;
    // Add
    protected ClassInfoSearchJfc jfcAdd;
    ...
    protected PageJfc jfcReferencePages;
    
    public ClassInfoJfcBase() {
        this.model = new ClassInfoModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public ClassInfoJfcBase(Hub<ClassInfo> hubClassInfo) {
        this.model = new ClassInfoModel(hubClassInfo);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public ClassInfoJfcBase(ClassInfoModel modelClassInfo) {
        if (modelClassInfo == null) this.model = new ClassInfoModel();
        else this.model = modelClassInfo;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("classInfo.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("classInfos.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<ClassInfo> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // ClassInfoJfcBase.this.getEditDialog(this).setVisible(true);
                ClassInfoJfcBase.this.onNewClassInfoCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<ClassInfo> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<ClassInfo> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, ClassInfo.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                ClassInfoJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ClassInfoJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                ClassInfo classInfo = ClassInfoJfcBase.this.onSearch();
                return classInfo;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClassInfoJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(ClassInfo.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ClassInfoJfcBase.this.customizeRenderer(lbl, ClassInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return ClassInfoJfcBase.this.getToolTipText(ClassInfoJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, ClassInfo classInfo, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(ClassInfo classInfo, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(ClassInfo.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ClassInfoJfcBase.this.customizeRenderer(lbl, ClassInfoJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(ClassInfo.P_Name), 12, 20) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                ClassInfoJfcBase.this.customizeRenderer(label, ClassInfoJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(ClassInfoJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(ClassInfoJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ClassInfoJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(ClassInfoJfc.getIcon());
        node.setForegroundColorProperty(ClassInfoJfc.PP_ForeColor);
        node.setBackgroundColorProperty(ClassInfoJfc.PP_BackColor);
        node.setIconColorProperty(ClassInfoJfc.PP_IconColor);
        node.setImageProperty(ClassInfoJfc.PP_Icon);
        node.setFontProperty(ClassInfoJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // ClassInfo client = (ClassInfo) table.getHub().getAt(row);
        // defaultValue = ClassInfoDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<ClassInfo> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<ClassInfo>(ClassInfo.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (ClassInfoJfcBase.this.getModel().getAllowGotoEdit()) {
                    ClassInfoJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "ClassInfo");
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ClassInfo.P_Name));
        }
        tc = table.addColumn("Core", 5, createCoreCheckBox());
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), ClassInfo.P_Created, 15);
        tc = table.addColumn("Created", 15, lbl);
        lbl = new OALabel(getHub(), ClassInfo.P_Name, 20);
        tc = table.addColumn("Name", 20, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ClassInfo.P_Name));
        }
        lbl = new OALabel(getHub(), ClassInfo.P_Core, 5);
        tc = table.addColumn("Core", 5, lbl);
    }
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(ClassInfo.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(ClassInfo.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClassInfoJfcBase.this.showCardPanel(ClassInfoJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClassInfoJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<ClassInfo>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", ClassInfo.P_Id);
        dd.addProperty("created", ClassInfo.P_Created);
        dd.addProperty("name", ClassInfo.P_Name);
        dd.addProperty("core", ClassInfo.P_Core);
    }
    // Card Panel
    ...
    public JPanel createEditCardPanel(JTabbedPane tp) {
        ...
        // cardPanel.add(getReferencePagesJfc().getCardPanel(), CARD_ReferencePages); // this will be created when needed by showCardPanel(..)
        return pan;
    }
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
        if (getModel().getPackageInfoModel().getCreateUI()) {
            lbl = new JLabel("Package Info:");
            gc.anchor = gc.WEST;
            panel.add(lbl, gc);
            gc.anchor = gc.NORTHWEST;
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createPackageInfoLabel();
            if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
            OAJfcControllerFactory.createOnlyAoNotNull(getHub(), lbl);
            cmd = createPackageInfoCommand();
            comp = olbl;
        ...
        Icon icon;
        icon = Resource.getJarIcon("page.gif");
        icon = new ScaledImageIcon(icon, 32, 20);
        pan = getReferencePagesJfc().createReadOnlyTablePanel();
        if (getModel().getReferencePagesModel().getCreateUI()) {
            this.TAB_ReferencePages = tabbedPane.getTabCount();
            tabbedPane.addTab("Reference Pages", icon, pan, null);
        }
        panel = panMain;
        return panel;
    }
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcReferencePages != null) {
            // need to create a new Jfc for dialog
            ClassInfoJfc jfc = new ClassInfoJfc(getModel());
        ...
        final Hub<ClassInfo> hub = new Hub<ClassInfo>(ClassInfo.class);
        hub.setSharedHub(ClassInfoJfcBase.this.getModel().getHub(), true);
        dlgEdit = new JDialog(win, getModel().getDisplayName(), ModalityType.MODELESS) {
            @Override
            public void setVisible(boolean b) {
                super.setVisible(b);
                if (b) hub.setSharedHub(ClassInfoJfcBase.this.getModel().getHub(), true);
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), ClassInfo.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), ClassInfo.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), ClassInfo.P_Name, 20);
    ...
    public OACheckBox createCoreCheckBox() {
        OACheckBox chk = new OACheckBox(getHub(), ClassInfo.P_Core);
        // chk.setText("Core")
        return chk;
    }
    
    public OATextField createDocTextField() {
        OATextField txt = new OATextField(getHub(), ClassInfo.P_Doc, 20);
        txt.setMinimumColumns(0);
        txt.setMaximumColumns(50);
        // setup(txt);
        return txt;
    ...
    public OALabel createPackageInfoLabel() {
        OALabel lbl = getPackageInfoJfc().createLabel();
        return lbl;
    }
    public JButton createPackageInfoCommand() {
        JButton cmd = null;
        cmd = getPackageInfoJfc().createGotoEditButton();
        return cmd;
    }
    ...
    public PackageInfoJfc getPackageInfoJfc() {
        if (jfcPackageInfo != null) return jfcPackageInfo;
        jfcPackageInfo = new PackageInfoJfc(getModel().getPackageInfoModel()) {
        };
        jfcPackageInfo.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcPackageInfo, this);
    ...
    public PageJfc getReferencePagesJfc() {
        if (jfcReferencePages == null) {
            jfcReferencePages = createReferencePagesJfc();
        }
        return jfcReferencePages;
    }
    public PageJfc createReferencePagesJfc() {
        jfcReferencePages = new PageJfc(getModel().getReferencePagesModel()) {
            @Override
            protected PageSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                PageSearchModel model = ClassInfoJfcBase.this.getModel().getReferencePagesSearchModel();
                jfcSearch = new PageSearchJfc(model, true, false);
                return jfcSearch;
            }
            @Override
            public JPanel getCardPanel() {
            ...
            public void showCardPanel(String name) {
                if (name.equals(PageJfc.CARD_List)) {
                    ClassInfoJfcBase.this.showCardPanel(CARD_Edit);
                    if (ClassInfoJfcBase.this.TAB_ReferencePages >= 0) {
                        ClassInfoJfcBase.this.getTabbedPane().setSelectedIndex(ClassInfoJfcBase.this.TAB_ReferencePages);
                    }
                }
                else if (name.equals(PageJfcBase.CARD_Edit)) {
                    ClassInfoJfcBase.this.showCardPanel(CARD_Edit);
                    if (ClassInfoJfcBase.this.TAB_ReferencePages >= 0) {
                        ClassInfoJfcBase.this.getTabbedPane().setSelectedIndex(ClassInfoJfcBase.this.TAB_ReferencePages);
                    }
                    ...
                    ClassInfoJfcBase.this.showCardPanel(CARD_ReferencePages);
            ...
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + ClassInfoJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        ClassInfoJfcBase.this.showCardPanel(ClassInfoJfcBase.this.CARD_Edit);
                        ClassInfoJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
        ...
        jfcReferencePages.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcReferencePages, this);
        return jfcReferencePages;
    }
    // OnShowCommands
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_ReferencePages)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getReferencePagesJfc().getCardPanel()) ) {
                cardPanel.add(getReferencePagesJfc().getCardPanel(), CARD_ReferencePages);
            }
        }
    ...
    protected void onNewClassInfoCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public ClassInfoSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        ClassInfoSearchModel modelSearch = new ClassInfoSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new ClassInfoSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (ClassInfo classInfo : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(classInfo)) {
                    getModel().getMultiSelectHub().add(classInfo);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            ClassInfo classInfo = getSearchHubJfc().getSelected();
            if (classInfo != null) {
                if (getHub().contains(classInfo)) {
                    getHub().setAO(classInfo);
                }
            }
        }
    }
    ...
    protected ClassInfoSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new ClassInfoSearchJfc();
        }
        return jfcSearch;
    }
    protected ClassInfo onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        ClassInfo classInfo = null;
        if (getSearchJfc().wasSelected()) classInfo = getSearchJfc().getSelected();
        return classInfo;
    }
    // Add
    protected ClassInfoSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new ClassInfoSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        ClassInfo classInfo = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        ClassInfoJfc ui = new ClassInfoJfc() {
            @Override
            protected ClassInfoSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new ClassInfoSearchJfc(false) {
                        @Override
