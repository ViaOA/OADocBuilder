...
public class SettingsBarBase {
    ...
    protected void setup() {
        ImageIcon icon = Resource.getJarIcon("rootSettingsSplash.png");
        JLabel lbl = new JLabel("Settings", icon, JLabel.CENTER);
        ...
        AppServerJfc jfcAppServer = new AppServerJfc(hubAppServer) {
            ...
            public void showCardPanel(final String name) {
                SettingsBarBase.this.cardLayout.show(SettingsBarBase.this.cardPanel, CARD_appServer);
                if (panx != null) {
                ...
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        ...
                        SettingsBarBase.this.cardPanel.add(panx, CARD_appServer);
                        showCardPanel(name);
                    }
                };
                sw.execute();
        ...
        AppUserJfc jfcAppUser = new AppUserJfc(hubAppUser) {
            ...
            @Override
            public void showCardPanel(final String name) {
                SettingsBarBase.this.cardLayout.show(SettingsBarBase.this.cardPanel, CARD_AppUsers);
                if (panx != null) {
                    super.showCardPanel(name);
                    return;
                }
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        ...
                        if (panx == null) panx = new JPanel();
                        SettingsBarBase.this.cardPanel.add(panx, CARD_AppUsers);
                        showCardPanel(name);
                    }
                };
                sw.execute();
        ...
        AppUserLoginJfc jfcAppUserLogin = new AppUserLoginJfc(hubAppUserLogin) {
            ...
            @Override
            public void showCardPanel(final String name) {
                SettingsBarBase.this.cardLayout.show(SettingsBarBase.this.cardPanel, CARD_AppUserLogins);
                if (panx != null) {
                    super.showCardPanel(name);
                    return;
                }
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        ...
                        if (panx == null) panx = new JPanel();
                        SettingsBarBase.this.cardPanel.add(panx, CARD_AppUserLogins);
                        showCardPanel(name);
                    }
                };
                sw.execute();
        ...
        AppUserErrorJfc jfcAppUserError = new AppUserErrorJfc(hubAppUserError) {
            ...
            @Override
            public void showCardPanel(final String name) {
                SettingsBarBase.this.cardLayout.show(SettingsBarBase.this.cardPanel, CARD_AppUserErrors);
                if (panx != null) {
                    super.showCardPanel(name);
                    return;
                }
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        ...
                        if (panx == null) panx = new JPanel();
                        SettingsBarBase.this.cardPanel.add(panx, CARD_AppUserErrors);
                        showCardPanel(name);
                    }
                };
                sw.execute();
    ...
    protected OATree getTree() {
        ...
        tree = new OATree(18) {
            ...
            public void nodeSelected(OATreeNode node) {
                ...
                if (node == null) {
                    SettingsBarBase.this.cardLayout.show(SettingsBarBase.this.cardPanel, SettingsBarBase.this.CARD_Splash);
                }
            }
        };
