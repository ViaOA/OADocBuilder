...
package com.viaoa.docbuilder.control.client;
...
import com.viaoa.docbuilder.control.AboutController;
import com.viaoa.docbuilder.control.HelpController;
import com.viaoa.docbuilder.control.LogController;
import com.viaoa.docbuilder.delegate.JfcDelegate;
...
import com.viaoa.docbuilder.view.client.ClientFrame;
/*$$Start: ClientFrameController.customize0 $$*/
import com.viaoa.docbuilder.view.client.panel.rootProjects.RootProjectsPanel;
import com.viaoa.docbuilder.view.client.panel.rootSettings.RootSettingsPanel;
/*$$End: ClientFrameController.customize0 $$*/
import com.viaoa.docbuilder.view.client.panel.application.ApplicationPanel;
...
public abstract class ClientFrameController {
	...
	public void onSaveAsPdf() {
		...
		SwingWorker<Boolean, String> sw = new SwingWorker<Boolean, String>() {
			...
			protected Boolean doInBackground() throws Exception {
				try {
					controlPdf.saveToPdf(controlPrint.getPrintable(), controlPrint.getPageFormat(), fileName, "docBuilder Report", userName);
				} catch (Throwable e) {
					error = e.getMessage();
	...
	protected void customize() {
        ...
        RootProjectsPanel panRootProjects = new RootProjectsPanel();
        frm.addPanel(panRootProjects.getMainComponent(), "RootProjectsPanel", panRootProjects.getMenuItem(), panRootProjects.getToggleButton());
        RootSettingsPanel panRootSettings = new RootSettingsPanel();
        frm.addPanel(panRootSettings.getMainComponent(), "RootSettingsPanel", panRootSettings.getMenuItem(), panRootSettings.getToggleButton());
